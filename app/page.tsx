...
export const metadata: Metadata = {
  title: "마블 라이벌즈 한글 패치노트 - 아이언맨, 토르, 스파이더맨 히어로 밸런스 업데이트",
  description: "마블 라이벌즈(Marvel Rivals) 최신 패치노트를 한글로 번역해드립니다. 아이언맨, 토르, 스파이더맨, 헐크, 캡틴 아메리카 등 33개 히어로의 스킬 버프/너프, 맵 업데이트, 메타 변화를 실시간으로 확인하세요. 매일 오후 6시 자동 업데이트.",
  keywords: [
    "마블 라이벌즈", "Marvel Rivals", "패치노트", "한글 패치", "게임 업데이트",
    "아이언맨 패치", "토르 패치", "스파이더맨 패치", "헐크 패치", "캡틴 아메리카 패치",
    "블랙위도우 패치", "호크아이 패치", "블랙팬서 패치", "닥터스트레인지 패치", "스칼렛위치 패치",
    "히어로 밸런스", "스킬 버프", "스킬 너프", "맵 업데이트", "메타 변경", "티어 리스트"
  ],
  openGraph: {
